...
var styles$1 = {"root":"styles-module_root__Xsw1F"};
...
const NavItem$2 = /*#__PURE__*/React__namespace.forwardRef((_ref, ref) => {
  let {
...
function useTabPanel(_ref) {
  ...
  const context = React.useContext(TabContext$1);
...
(_ref2, ref) => {
  ...
  return /*#__PURE__*/jsxRuntime.jsx(TabContext$1.Provider, {
    value: null,
...
const TabContainer = ({
  transition,
  ...props
}) => /*#__PURE__*/jsxRuntime.jsx(BaseTabs, {
  ...props,
...
const MockChatComponent = () => {
    const [messages, setMessages] = React.useState([
        {
            text: '<h3 class="m-0">Enter Service Address</h3>',
            isUser: false,
            isTitle: true,
        },
        {
    ...
    return (React.createElement("div", null,
        messages.map((message, index) => (React.createElement("div", { key: index, className: `${message.isUser
                ...
                : message.isInstruction
                    ...
                    : message.isTitle
                        ? 'text-black text-lg font-semibold leading-6 mt-2 mb-4'
        ...
        inputVisible && (React.createElement("div", { className: "mt-2 flex rounded-md shadow-sm" },
...
const ChatBot = ({ closeChatBot }) => {
    ...
    return (React.createElement("div", { className: `${styles.mainWrapBlue} rounded-top-4 d-flex flex-column` },
        React.createElement("div", { className: "d-flex justify-content-between my-3 px-3" },
            React.createElement("h4", { className: "fs-4 fw-bold m-0" }, "Agent Assist"),
            React.createElement("span", { onClick: closeChatBot, className: `${styles.minimizeButton} d-flex justify-content-center align-items-center rounded-circle` },
                React.createElement("span", { className: "material-icons" }, "close"))),
        React.createElement(Tab$1.Container, { defaultActiveKey: "tabScript" },
            React.createElement("div", { className: `${styles.navWrap} mb-3 mx-3 p-2 rounded` },
                React.createElement(Nav$1, { variant: "pills", className: `${styles.buttonsNavHome} gap-1 justify-content-between` },
                    React.createElement(Nav$1.Item, null,
                        React.createElement(Nav$1.Link, { className: "py-1 px-2 d-flex align-items-center gap-1", eventKey: "tabScript" },
                            React.createElement("span", { className: "material-icons" }, "description"),
                            "Script")),
                    React.createElement(Nav$1.Item, null,
                        React.createElement(Nav$1.Link, { className: "py-1 px-2 d-flex align-items-center gap-1", eventKey: "tabHelp" },
                            React.createElement("span", { className: "material-icons" }, "search"),
                            "Help")),
                    React.createElement(Nav$1.Item, null,
                        React.createElement(Nav$1.Link, { className: "py-1 px-2 d-flex align-items-center gap-1", eventKey: "tabTranscript" },
                            React.createElement("span", { className: "material-icons" }, "record_voice_over"),
                            "Transcript")))),
            React.createElement("div", { className: `${styles.promptTabContainer} d-flex flex-column flex-grow-1` },
                React.createElement(Tab$1.Content, { className: "flex-grow-1" },
                    React.createElement(Tab$1.Pane, { eventKey: "tabScript", className: "h-100" },
                        React.createElement("div", { className: "position-relative h-100 d-none" },
                            React.createElement("div", { className: `${styles.chatPanelWrap} h-100 px-3`, ref: messagesContainerRef },
                                React.createElement("div", { className: `${styles.stepContent} mb-3` },
                                    React.createElement("h4", { className: "fs-6 fw-bold" }, "Step 3: Phone Configuration"),
                                    React.createElement("p", { className: "m-0" }, "In this step, you can configure the phone line with calling features and offer phone number porting or search for a prefered number for the customer")),
                                messages.map((message) => (React.createElement("div", { key: message.id, className: `${message.sender === 'you' ? styles.sent : styles.received} mb-3 p-3 shadow-sm ${styles.chatBubble}` }, message.text)))),
                            React.createElement("div", { className: "position-absolute bottom-0 end-0 start-0 px-3 py-2 bg-info d-flex gap-2" },
                                React.createElement(Form$1.Control, { className: `${styles.inputText} rounded-5`, placeholder: "Type here...", "aria-label": "Type", value: inputValue, onChange: (e) => setInputValue(e.target.value) }),
                                React.createElement(Button$1, { onClick: sendMessage, className: `${styles.sendButton} d-inline-flex bg-light justify-content-center align-items-center rounded-circle p-0` },
                                    React.createElement("span", { className: "material-icons text-dark fs-5" }, "send")))),
                        React.createElement(MockChatComponent, null)),
                    React.createElement(Tab$1.Pane, { eventKey: "tabHelp" }, "..."),
                    React.createElement(Tab$1.Pane, { eventKey: "tabTranscript" }, "..."))))));
};
...
const ChatComponent = () => {
    ...
    return React.createElement("div", { className: styles$1.root }, showChat && React.createElement(ChatBot, { closeChatBot: closeChatBot }));
};
